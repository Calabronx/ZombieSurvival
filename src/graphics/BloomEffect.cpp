...
BloomEffect::BloomEffect()
	...
	, mSecondPassTextures()
{
	mShaders.load(Shaders::BrithnessPass,		"resources/shaders/Fullpass.vert",	"resources/shaders/Brightness.frag");
...
{
	sf::Shader& brightness = mShaders.get(Shaders::BrithnessPass);
